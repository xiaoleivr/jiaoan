"""
Django settings for python1812 project.
...
SECRET_KEY = 'xui^fi4hd(k3jn1g_nta!@#qyh*6nb_9^g_ati5r%lfg6^_%c@'
...
WSGI_APPLICATION = 'python1812.wsgi.application'
